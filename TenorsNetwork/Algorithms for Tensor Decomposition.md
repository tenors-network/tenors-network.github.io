...
[[Tensor Low Rank Approximation]] problems are also studied.
...
$$
 F = \sum_{i=1}^{r} \omega_i L_i^d
$$
where  $\omega_i \in \mathbb{k}$, $L_i$ is a linear form (of degree $1$). The minimal $r$ is called the *rank* of $F$.
...
A Generalized Additive Decomposition (GAD)  of a symmetric tensor $F$ of order $d$ is
$$
