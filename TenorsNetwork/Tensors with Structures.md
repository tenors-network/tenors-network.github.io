...
The takeaway message is that having structure on your tensors is not just an extra restriction, instead it is useful geometric information that, when incorporated in the decomposition methods, often allows to solve decompositions problems that would otherwise be out of reach.
