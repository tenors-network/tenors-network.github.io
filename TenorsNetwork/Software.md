...
- **MomentPolynomialOpt.jl**: solvers of moment and [[Polynomial Optimization|polynomial optimization]] problems based on moment relaxations
 ...
 - **AlgebraicSolvers.jl**: solvers of zero-dimensional multivariate polynomial equations, using normal form computations based on resultant constructions, Groebner basis, ...
